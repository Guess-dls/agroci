-- Mise à jour: l'acheteur ne paie que quand le producteur accepte
...
BEGIN
  ...
  -- Vérifier les crédits suffisants (sans déduire)
...
-- Mise à jour: déduire les crédits des DEUX parties lors de l'acceptation
